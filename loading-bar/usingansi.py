from ansiescapes import cursorMove
...
while progress <= 100.00:
    print("\r{}".format(CreateProgressBar(50, 100, progress, showPct=True)), end="")
...
print(CreateProgressBar(50, 100, progress, showPct=True), end="")

while progress <= 100:
    write(cursorMove(-(barLength - int(barLength * pct))) + "#")
    progress += 0.01
    sleep(0.01)
